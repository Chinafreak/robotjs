...
test('Toggle Key Toggle based on Unicode.', function (t) {
  t.plan(7);
  t.ok(robot.unicodeToggle("r".charCodeAt(0), "down") === 1, 'successfully pressed "r".');
  t.ok(robot.unicodeToggle("r".charCodeAt(0), "up") === 1, 'successfully released "r".');
  t.ok(robot.unicodeToggle("ά".charCodeAt(0), "down") === 1, 'successfully pressed "ά".');
  t.ok(robot.unicodeToggle("ά".charCodeAt(0), "up") === 1, 'successfully released "ά".');
  t.ok(robot.unicodeToggle("ö".charCodeAt(0), "down") === 1, 'successfully pressed "ö".');
  t.ok(robot.unicodeToggle("ö".charCodeAt(0), "up") === 1, 'successfully released "ö".');
  t.ok(robot.unicodeToggle("ち".charCodeAt(0), "down") === 1, 'successfully pressed "ち".');
  t.ok(robot.unicodeToggle("ち".charCodeAt(0), "up") === 1, 'successfully released "ち".');
  t.ok(robot.unicodeToggle("嗨".charCodeAt(0), "down") === 1, 'successfully pressed "嗨".');
  t.ok(robot.unicodeToggle("嗨".charCodeAt(0), "up") === 1, 'successfully released "嗨".');
  t.ok(robot.unicodeToggle("ఝ".charCodeAt(0), "down") === 1, 'successfully pressed "ఝ".');
  t.ok(robot.unicodeToggle("ఝ".charCodeAt(0), "up") === 1, 'successfully released "ఝ".');

  t.throws(function () {
    robot.unicodeToggle();
  }, /Invalid character typed./, 'toggled nothing.');
});
