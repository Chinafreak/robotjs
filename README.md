# About this fork
This repo is a fork from <a href="https://github.com/octalmage/robotjs">octalmage/robotjs</a> with unicode keycode support "unicodeTap(unicode)" and "unicodeToggle(unicode, down)". It's pretty similar to keyTap/keyToggle. It supports Windows (Mac not tested, but it may work. Linux support needed!)
